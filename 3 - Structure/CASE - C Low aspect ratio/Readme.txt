#######################################################################################################################################
CASE C : Low aspect ratio wing with various composite layouts
#######################################################################################################################################
This folder is organized as follow
   ...
   /[0_3_90]_S]/ /[+15_2_0_2]_S /[-15_2_0_2]_S folders contains the screenshots of the references documents used to get 
                                               ...
                                               LCO_Z = limit cycle oscillations amplitude of the tip altitude 
                                               LCO_T = limit cycle oscillations amplitude of the tip twist 


References for the experimental data:
1 - Dunn, P. (1992). NONLINEAR STALL FLUTTER of WINGS with BENDING-TORSION COU-
PLING. PhD thesis, MIT, Boston, MA.

2 - Dunn, P. and Dugundji, J. (1992). Nonlinear stall flutter and divergence analysis 
of cantilevered graphite/epoxy wings. AIAA Journal
